  ...
  export default {
    ...
    methods: {
      async fetchData() {
        ...
        const profInfo = await fetch("https://api.skapex.ru/api/User/1/public");
        this.data = await profInfo.json();
      }
    },
    mounted(){
      this.fetchData()
